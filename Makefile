...
utils.o: src/utils.c src/utils.h
	gcc -fprofile-arcs -ftest-coverage -c src/utils.c -o build/utils.o

insertion.o: src/insertion.c src/insertion.h src/utils.h
	gcc -fprofile-arcs -ftest-coverage -c src/insertion.c -o build/insertion.o

utils-test.o: src/tests/utils-test.c
	gcc -fprofile-arcs -ftest-coverage -c src/tests/utils-test.c -o build/utils-test.o

insertion-test.o: src/tests/insertion-test.c
	gcc -fprofile-arcs -ftest-coverage -c src/tests/insertion-test.c -o build/insertion-test.o
